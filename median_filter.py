...
out_filename = 'q100_s_median_3.jpg'
...
for h in range(1, height-1):
  for w in range(1, width-1):
    ...
    median_data[h, w, 0] = pixel_value_b[4]
    median_data[h, w, 1] = pixel_value_g[4]
    median_data[h, w, 2] = pixel_value_r[4]

    if h==10 and w ==10:
      print('ソート後')
      print(f'h = {h} w = {w} y = {y} x = {x}')
      print(pixel_value_r)
      print(median_data[h+1, w+1, 2])
